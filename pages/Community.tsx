      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        ...
        <div className="flex px-4 gap-8">
          <button
            ...
            className={`border-b-[3px] pb-3 pt-1 text-sm font-bold transition-all ${activeTab === 'posts' ? 'border-primary text-text' : 'border-transparent text-text-muted'
              }`}
          >
            动态
          </button>
          <button
            ...
            className={`border-b-[3px] pb-3 pt-1 text-sm font-bold transition-all ${activeTab === 'groups' ? 'border-primary text-text' : 'border-transparent text-text-muted'
              }`}
          >
            同路人小组
          </button>
          ...
          <div className="p-4 flex gap-3 overflow-x-auto no-scrollbar">
            {COMMUNITY_TAGS.map((tag) => (
              <button
                ...
                className={`flex h-8 shrink-0 items-center px-4 rounded-xl text-xs font-bold shadow-sm whitespace-nowrap transition-all active:scale-95 ${activeTag === tag
              ...
              >
                ...
                <div className="p-5 flex flex-col">
                  ...
                  <button
                    ...
                    className={`w-full py-3.5 rounded-xl font-bold text-sm transition-all active:scale-[0.98] ${group.isJoined
                ...
                <div className="flex flex-wrap gap-2">
                  {GROUP_CATEGORIES.map(cat => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-xs font-bold transition-all border ${createFormData.tag === cat
